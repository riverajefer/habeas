                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/password/reset') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" disabled  class="form-control" name="email_t4" value="{{ $email or old('email') }}">
                                <input id="email" type="hidden"  class="form-control" name="email_t4" value="{{ $email or old('email') }}">
