...
trait ResetsPasswords
{
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        $response = Password::broker($broker)->sendResetLink($request->only('email_t4'), function (Message $message) {
...
*/
    ...
    {
        $this->validate($request, ['email_t4' => 'required|email']);
    }
    ...
    {
        return $request->only(
            'email_t4', 'password', 'password_confirmation', 'token'
        );
    }
